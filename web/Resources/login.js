...
function validateForm() {
    $("#frm-acceso").validate({
        ...
        messages: {
            corr: {
                ...
                maxlength: "No puedes ingresar más de 120 caracteres"
            },
            contra: {
                required: "No puedes dejar este campo vacío",
                minlength: "Debes ingresar al menos 4 caracteres",
                maxlength: "No puedes ingresar más de 32 caracteres"
            }
        },
        errorElement: "div",
        errorClass: "invalid",
    ...
    $("#frmUsr").validate({
        ...
        messages: {
            nomusuario: {
                required: "Ingresar el nombre del usuario",
                minlength: "ingrese minimo 4 caracteres",
                maxlength: "Ingrese maximo 120 caracteres"
            },
            correo: {
                required: "Ingresar el correo del usuario",
                email: "Ingrese una direccion de correo valida",
                minlength: "ingrese minimo 4 caracteres",
                maxlength: "Ingrese maximo 120 caracteres"
            },
            contraseña: {
                required: "Ingresar la contraeña del usuario",
                minlength: "ingrese minimo 4 caracteres",
                maxlength: "Ingrese maximo 40 caracteres"
            },
            domicilio: {
                required: "Ingresar el domicilio del usuario",
                minlength: "ingrese minimo 4 caracteres",
                maxlength: "Ingrese maximo 250 caracteres"
            }
        },
        errorElement: "div",
        errorClass: "invalid",
            ...
            if (response["status"] >= 1) {
                if (response["status"] == 1) {
                    window.location.href =
                        "http://127.0.0.1/symfony/EmpresasSymfony/web/app_dev.php/";
                    M.toast({
                    ...
                    window.location.href =
                        "http://127.0.0.1/symfony/EmpresasSymfony/web/app_dev.php/catempresas";
                    M.toast({
                        html: "Acceso Permitido",
                        classes: "rounded",
                        displayLength: 4000
